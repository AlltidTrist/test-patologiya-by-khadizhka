...
function showResults() {
    ...
    if (percentage === 100) {
        ...
        message = 'Ты ничего не сдашь, брайтанчик, заканчивай и открывай тик ток, оно вообще тебе не надо, медицина не твое';
        messageClass = 'good';
    } else if (percentage <= 30) {
        message = 'Не, братан, ты именно вообще ничего не понимаешь';
        messageClass = 'bad';
    }else  {
        message = 'Еще раз давай';
        messageClass = 'good';
    }
